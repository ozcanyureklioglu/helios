...
public class CreateWarehouseInventoryEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        ...
        .Produces<Application.Common.Models.ApiResponse<Vectomera.Application.Features.WarehouseInventories.Dtos.BulkCreateWarehouseInventoryResponse>>(StatusCodes.Status200OK)
        .Produces<Application.Common.Models.ApiResponse<Vectomera.Application.Features.WarehouseInventories.Dtos.BulkCreateWarehouseInventoryResponse>>(StatusCodes.Status400BadRequest);
    }
}
